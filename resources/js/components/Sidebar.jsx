    ...
    return (
        ...
        >
                    ...
                    <li key={route}>
                        ...
                        >
                            ...
                            {isFinite(props.count[route]) && (
                                <span className="count justify-self-end text-xs">
                                    {props.count[route]}
                                </span>
                            )}
                        </Link>
            ...
            <div className="mt-auto">
                <div
                    className={`flex items-center gap-3 ${isExpanded ? "" : "flex-col"}`}
                >
                ...
                >
                    {isExpanded
                        ? props.year?.year
                        : props.year?.year.split("/")[0].slice(2, 4) +
                          "/" +
                          props.year?.year.split("/")[1].slice(2, 4)}
                </div>
            </div>
        </aside>
    );
